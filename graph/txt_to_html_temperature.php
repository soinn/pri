...
fputs($fp, "<ul>\n");
fputs($fp, "<li><?php echo \"<a href='txt_to_html_temperature.php?login=$login ' class='active' >Temperature</a>\"; ?></li>\n");
...
fputs($fp, "<h1>Temperature Graph</h1></br>\n");
...
fputs($fp, "[ { data: weight2, label: \"temperature\"}], {\n");
fputs($fp, "series: {\n");
