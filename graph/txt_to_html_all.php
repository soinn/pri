...
<?php echo "<META http-equiv='refresh' content='2;URL=graph_all.php?login=".$login."'>";?>
<p>Génération des graphes</p>
<?php 

unlink ("graph_all.php");

$fp = fopen("graph_all.php","w+");
...
fputs($fp, "<li><?php echo \"<a href='txt_to_html_weight.php?login=$login ' class='active'>Weight</a>\"; ?></li>\n");
...
fputs($fp, "<h1>vVO2max Graph</h1></br>\n");
fputs($fp, "<center><div id=\"placeholder\" style=\"width:600px;height:300px\"></div></center>\n");
fputs($fp, "</br><p>This the graph of your vVO2max, each point match with one of your training and the weight you recorded during this training.</p>\n");
fputs($fp, "</br><p>This is time in x-axis and vVO2max (km/h) in y-axis.</p>\n");
fputs($fp, "</br><p id=\"hoverdata\">Mouse hovers at\n");
fputs($fp, "(<span id=\"x\">0</span>, <span id=\"y\">0</span>). <span id=\"clickdata\"></span></p>\n");
fputs($fp, "\n");
fputs($fp, "\n");
...
fputs($fp, "<?php echo \"<p><a href='txt_to_html_all.php?login=$login '>All Graphs</a></p>\"; ?>\n");
fputs($fp, "</aside>\n");
fputs($fp, "</section>\n");
