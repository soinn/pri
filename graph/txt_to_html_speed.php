...
<?php echo "<META http-equiv='refresh' content='2;URL=graph_speed.php?login=".$login."'>";?>
<p>Génération du graphe</p>
<?php 

unlink ("graph_speed.php");

$fp = fopen("graph_speed.php","w+");
...
fputs($fp, "?>\n");
fputs($fp, "<h1>Speed Graph</h1></br>\n");
fputs($fp, "<center><div id=\"placeholder\" style=\"width:600px;height:300px\"></div></center>\n");
fputs($fp, "</br><p>This the graph of your speed, each point match with one of your training and the weight you recorded during this training.</p>\n");
fputs($fp, "</br><p>This is time in x-axis and km/h in y-axis.</p>\n");
...
fputs($fp, "[ { data: weight2, label: \"speed\"}], {\n");
fputs($fp, "series: {\n");
