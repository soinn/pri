...
fputs($fp, "<li><?php echo \"<a href='txt_to_html_speed.php?login=$login ' class='active' >Speed</a>\"; ?></li>\n");
...
fputs($fp, "</br><p>This the graph of your speed, each point match with one of your training and the speed you recorded during this training.</p>\n");
