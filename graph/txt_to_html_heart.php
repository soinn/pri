...
fputs($fp, "<li><?php echo \"<a href='txt_to_html_heart.php?login=$login ' class='active' >Heart Rate</a>\"; ?></li>\n");
...
fputs($fp, "</br><p>This the graph of your heart Rate, each point match with one of your training and the pulsations you recorded during this training.</p>\n");
