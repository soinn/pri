...
<?php echo "<META http-equiv='refresh' content='2;URL=graph_heart.php?login=".$login."'>";?>
<p>Génération du graphe</p>
<?php 

unlink ("graph_heart.php");

$fp = fopen("graph_heart.php","w+");
...
fputs($fp, "?>\n");
fputs($fp, "<h1>Heart Rate Graph</h1></br>\n");
fputs($fp, "<center><div id=\"placeholder\" style=\"width:600px;height:300px\"></div></center>\n");
fputs($fp, "</br><p>This the graph of your heart Rate, each point match with one of your training and the weight you recorded during this training.</p>\n");
fputs($fp, "</br><p>This is time in x-axis and puls/min in y-axis.</p>\n");
...
fputs($fp, "[ { data: weight2, label: \"heart rate\"}], {\n");
fputs($fp, "series: {\n");
...
fputs($fp, "<?php echo \"<p><a href='graph/txt_to_html_temperature.php?login=$login '>Temperature Graph</a></p>\"; ?>\n");
fputs($fp, "<?php echo \"<p><a href='graph/txt_to_html_weight.php?login=$login '>Weight Graph</a></p>\"; ?>\n");
fputs($fp, "<?php echo \"<p><a href='graph/txt_to_html_heart.php?login=$login '>Heart Rate Graph</a></p>\"; ?>\n");
fputs($fp, "<?php echo \"<p><a href='graph/txt_to_html_vma.php?login=$login '>VMA Graph</a></p>\"; ?>\n");
fputs($fp, "<?php echo \"<p><a href='graph/txt_to_html_distance.php?login=$login '>Distance Graph</a></p>\"; ?>\n");
fputs($fp, "<?php echo \"<p><a href='graph/txt_to_html_speed.php?login=$login '>Speed Graph</a></p>\"; ?>\n");
fputs($fp, "<?php echo \"<p><a href='graph/txt_to_html_time.php?login=$login '>Time Graph</a></p>\"; ?>\n");
fputs($fp, "</aside>\n");
fputs($fp, "</section>\n");
