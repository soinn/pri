...
<?php echo "<META http-equiv='refresh' content='2;URL=graph_distance.php?login=".$login."'>";?>
<p>Génération du graphe</p>
<?php 

unlink ("graph_distance.php");

$fp = fopen("graph_distance.php","w+");
...
fputs($fp, "?>\n");
fputs($fp, "<h1>Distance Graph</h1></br>\n");
...
fputs($fp, "</br><p>This is time in x-axis and kilometers in y-axis.</p>\n");
