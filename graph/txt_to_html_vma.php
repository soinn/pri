...
<?php echo "<META http-equiv='refresh' content='2;URL=graph_vma.php?login=".$login."'>";?>
<p>Génération du graphe</p>
<?php 

unlink ("graph_vma.php");

$fp = fopen("graph_vma.php","w+");
...
fputs($fp, "?>\n");
fputs($fp, "<h1>VMA Graph</h1></br>\n");
fputs($fp, "<center><div id=\"placeholder\" style=\"width:600px;height:300px\"></div></center>\n");
fputs($fp, "</br><p>This the graph of your vma, each point match with one of your training and the weight you recorded during this training.</p>\n");
fputs($fp, "</br><p>This is time in x-axis and vma in y-axis.</p>\n");
